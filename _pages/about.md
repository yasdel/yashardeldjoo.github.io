...
<p> I am tenure-track (Italian RtD-B) assistant professor at the Department of Electrical and Information Engineering, Polytechnic University of Bari (PoliBa) in Italy. I have been a visiting researcher at both the University of San Diego (USA) and the Johannes Kepler University (Austria). I received my Ph.D. in CS, with a focous on recommender systems, at Polytechnic University of Milan (Polimi), Italy and my M.Sc. in EE, at Chalmers Univeristy of Technology, where I did my MSc. thesis at Ericsson Research, Stockholm (Sweden). My research focuses on developing *trustworthy* ML for information-seeking (in particular recommendation, and conversational agents) in order to better understand their robustness, fairness, privacy, generalizability, and interpretability, as well as (ii) developing multimodal recommendation and conversational systems. I am an active member of the recommender systems community, typically publisihng at major venues such as SIGIR, RecSys, CIKM, CVPR and WSDM. I contributed to a handful of <u>10 literature reviews</u> in prestigious journals such as the ACM Computing Surveys, featuring a spectrum of topics around recommender ststems and machine-learning, such as <i>adversarial machine learning</i>, <i>algorithmic fairness</i>, and domain-specific tasks such as <i>fashion</i>, <i>multimedia</i>, <i>interactive QA</i> and <i>music recommender system</i>. I have further had the honor of contributing <u>two</u> book chapters to the recommender systems handbook (3rd Edition, 2022), the <u>best book</u> currently in the RecSys community. From 2017 to 2020, I was an organizer of a series of machine-learning challenges in cooperation with major industry players such as Twitter, Xing or Spotify.
  

  In my research, I am interested in generalisation and robustness in deep learning and reinforcement learning.
  
  He received the ONR's Young Investigator Award in 2022, an NSF CAREER Award in 2020 and a Simons-Berkeley Research Fellowship on deep learning foundations in 2019. He is the recipient of several other awards including two best paper awards, a teaching award and multiple faculty awards from industry such as IBM, AWS and Qualcomm. He is the organizer of the UMD's Rising Stars in Machine Learning program. My current research focuses on fairness and 


  
  
  My name is Yashar Deldjoo. I am a tenure-track (Italian Rtd-B) assistant professor at Polytechnic University of Bari, working at the Information Systems Laboratory (SisInf Lab), under the direction of <a href="http://sisinflab.poliba.it/dinoia/" target="\_blank" style="color: #B509AC">Tommaso di Noia</a>. 
  
  
  I was previousely a Postdoc at the Institute for Machine Learning, at the Johannes Kepler University of Linz. In my research, I am interested in generalisation and robustness in deep learning and reinforcement learning.
  
  
  
  I am currently on a sabbatical at the University of California, San Diego, where I am working with <a href="https://cseweb.ucsd.edu/~jmcauley/" target="\_blank" style="color: #B509AC">  Julian McAuely</a>. I work as an assistant professor at <a href="http://www.en.poliba.it/" target="\_blank" style="color: #B509AC">Polytechnic University of Bari</a> in Italy, where I am a member of the Information Systems Laboratory (SisInf Lab), under the direction of <a href="http://sisinflab.poliba.it/dinoia/" target="\_blank" style="color: #B509AC">Tommaso di Noia</a>. Specifically, my research focuses on developing trustworthy machine learning for information-seeking (in particular recommendation, QA, and conversational agents) in order to better understand their robustness, fairness, privacy, generalizability, and interpretability, as well as (ii) developing multimodal recommendation and conversational systems. A number of our recent publications, including SIGIR'21, CIKM'21, and AdvML@KDD'21, have received the <u>best paper</u> award and appreciation from the scientific community. <br> <br> 
 
  I am an active member of the recommender systems community, having published/presented tutorials at premier conferences and top-tier journals. I have contributed to more than <u>10 literature reviews</u> in prestigious journals such as the ACM Computing Surveys, where I have served as the lead author in majority of the surveys. The surveys cover a spectrum of topics around recommender ststems and machine-learning, such as <i>adversarial machine learning</i>, <i>algorithmic fairness</i>, and domain-specific tasks such as <i>fashion</i>, <i>multimedia</i>, <i>interactive QA</i> and <i>music recommender system</i>. I have further had the honor of contributing <u>two</u> book chapters to the recommender systems handbook (3rd Edition, 2022), the <u>best book</u> currently in the RecSys community. From 2017 to 2020, I was an organizer of a series of machine-learning challenges in cooperation with major industry players such as Twitter, Xing or Spotify. <br> 
<br> 
</p>
